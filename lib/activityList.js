   ...
   *
   ************************************************************************/
export function setupActivityList(metaProperty, filter) {
  ...
  function getActivityListFirst() {
    return (activityListFirst !== null) ? activityListFirst.proxy : null;
  }
  
  function getActivityListLast() {
    return (activityListLast !== null) ? activityListLast.proxy : null;
  }
