/**
  ...
  Local Disconnect, Reconnect, Clear and Deallocate. = LDRCD
  ...
  c) If an object has been cleared, it is write protected as long as it is not reconnected to the persistent spanning tree by the application.  
